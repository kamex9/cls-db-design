...
ALTER TABLE `contract_document_assignees` ADD FOREIGN KEY (`contract_document_id`) REFERENCES `contract_documents` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `contract_document_counterparties` ADD FOREIGN KEY (`contract_document_id`) REFERENCES `contract_documents` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `contract_document_categories` ADD FOREIGN KEY (`contract_document_id`) REFERENCES `contract_documents` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `contract_document_articles` ADD FOREIGN KEY (`contract_document_id`) REFERENCES `contract_documents` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `project_counterparties` ADD FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `project_assignments` ADD FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `project_events` ADD FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `project_event_attachments` ADD FOREIGN KEY (`project_event_id`) REFERENCES `project_events` (`id`) ON DELETE CASCADE;
